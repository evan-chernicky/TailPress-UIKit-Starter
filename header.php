...
<div id="page" class="min-h-screen flex flex-col">
	...
	<div id="content" class="site-content flex-gro">
		...
		<?php if ( is_front_page() ) { ?>
			...
			<div class="container mx-auto">
				...
				<div uk-lightbox>
    <a class="uk-button uk-button-default" href="/wp-content/themes/tailpress/assets/playhouse.jpg" data-caption="Caption">Open Lightbox</a>
</div>
<?php print_r(get_template_directory_uri() . '/assets/playhouse.jpg')?>
